...
//                switch(cat)
//                {
//                    case "admin": catDisplay="Headquarter";
//                                    break;
//                    case "college": catDisplay="Branch";
//                                    break;
//                    case "vender": catDisplay="Vendor";
//                                    break;
//                    case "contractor": catDisplay="Civil Contractor";
//                                    break;
//                    default : catDisplay="W";break;
//                }
//            }
...
<!--                        <div style="border: 1px solid #AAA;width: 740px;background: #ccffcc;border-radius: 15px;margin-bottom: 1px;height: 25px;line-height: 25px; font-size: 15px; color: #505050;font-family: serif">
            ...
            if(request.getAttribute("temp")!=null)
            {
                ...
                <div class="alert-box error" style="width: 360px">
                    <font color="red"><b><%out.println(request.getAttribute("temp"));%></b></font>
                </div>
                    ...
                    <fieldset style="width: 400px; border: 1px solid #AAA; background: #EFF;border-radius: 15px;">
                        ...
                        <table id="simple" align="center">
                            ...
                            <tr><td colspan="2"  style="background: #EFF">
                                ...
                                <% if("catDisplay".equals("Vendor")||"catDisplay".equals("Civil Contractor"))
                                {
                                %>
                                <a href="resetPass.jsp" style="font-size: 11px; ">
                                    Forgot Password ?</a>
                                <%}
                                else if("catDisplay".equals("Headquarter"))
                                { 
                                   %>
                                ...
                                <%
                                if(("cat1"==null && "cat"==null)|| "catDisplay".equals("W") ){
                                    %>
